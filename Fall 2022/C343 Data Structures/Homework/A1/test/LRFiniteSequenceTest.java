...
class LRFiniteSequenceTest {
    ...
    @Test
    void removeToOutofbounds () throws SeqFullE, SeqAccessE {
        assertEquals(0, seq.size());

        assertThrows(SeqAccessE.class, () -> seq.removeLeft());
        assertThrows(SeqAccessE.class, () -> seq.removeRight());
    }

    @Test
    void addTooManyLeft () throws SeqFullE {
        assertEquals(0, seq.size());
    ...
    @Test
    void addTooManyRight () throws SeqFullE {
        assertEquals(0, seq.size());
