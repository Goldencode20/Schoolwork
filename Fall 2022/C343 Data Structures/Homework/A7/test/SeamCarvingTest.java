...
public class SeamCarvingTest {
    ...
    //@Test
    public void curse () throws IOException {
        SeamCarving sc = new SeamCarvingH("curse.jpeg");
        sc.cutN(sc.getImg().getWidth() / 4);
        sc.write("half-");
    }

    @Test
    public void moto () throws IOException {
        SeamCarving sc = new SeamCarvingH("moto.jpg");
        sc.cutN(sc.getImg().getWidth() / 3);
        sc.write("2-3-");
    }

    @Test
    public void eagle () throws IOException {
        SeamCarving sc = new SeamCarvingH("eagle.jpg");
        sc.cutN(sc.getImg().getWidth() / 3);
        sc.write("2-3-");
    }
}