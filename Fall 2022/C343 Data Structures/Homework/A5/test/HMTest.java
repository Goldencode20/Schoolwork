...
public class HMTest {
    ...
    @Test
    void containsKeyHM() {  //I can't see why the test is failing in the autograder, and it seems to be breaking the other tests in the autograder
        HM<Integer,Integer> hm = new HM<>(2);
        hm.put(1,10);
        hm.put(2,10);
        hm.put(3,10);
        hm.rehash();
        assertFalse(hm.put(3,21));
        assertFalse(hm.put(2,21));
        assertTrue(hm.containsKey(1));
        ...
        hm.put(6,10);
        hm.put(5,10);
        assertTrue(hm.containsKey(6));
        assertTrue(hm.containsKey(5));
    }
