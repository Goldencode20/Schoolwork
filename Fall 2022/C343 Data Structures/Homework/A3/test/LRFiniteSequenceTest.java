...
class LRFiniteSequenceTest {
    ...
    public void clear(){
        seq.clear();
        assertEquals(16, seq.getCapacity());
    }
    ...
    public void contains(){
        ...
        assertEquals(true, seq.contains(5));
    }

    @Test
    public void insertLeftAll(){
        ArrayList<Integer> seq2 = new ArrayList<>();

        seq2.add(5);
        seq2.add(3);
        seq.insertLeftAll(seq2);

        assertEquals(seq.toString(), "[Optional[5], Optional[3], Optional.empty, Optional.empty, Optional.empty]");
    }
    ...
    public void containsAll(){
        ...
        assertEquals(true, seq.contains(5));
        assertEquals(true, seq.contains(3));

        assertEquals(true, seq.containsAll(seq2));
    }
    ...
    public void leftIterator() {
        ...
        seq.insertLeft(3);
        assertEquals(seq.toString(),
                "[Optional[1], Optional[2], Optional[3], Optional.empty, Optional.empty]");

        seq.insertLeft(4);
        assertEquals(seq.toString(),
                "[Optional[1], Optional[2], Optional[3], Optional[4], Optional.empty]");

        seq.insertLeft(5);
        assertEquals(seq.toString(),
                "[Optional[1], Optional[2], Optional[3], Optional[4], Optional[5]]");

        Iterator<Integer> temp = seq.iterator();
        assertEquals(true, seq.iterator().hasNext());
        assertEquals(1, temp.next());
        assertEquals(2, temp.next());
        assertEquals(3, temp.next());
        assertEquals(4, temp.next());
        assertEquals(5, temp.next());
        assertEquals(null, temp.next());
    ...
    public void rightIterator() {
        ...
        Iterator<Integer> temp = seq.descendingIterator();
        assertEquals(true, temp.hasNext());
        assertEquals(5, temp.next());
        assertEquals(4, temp.next());
        assertEquals(3, temp.next());
        assertEquals(2, temp.next());
