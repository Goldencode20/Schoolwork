...
class debug:
    ...
    def debug_informationGain(self):
        ...
        ig_test = calc_information_gain(parent_classifications, {1:child1_classifications, 2:child2_classifications}, {1:3, 2:5})
        print(ig_test)
